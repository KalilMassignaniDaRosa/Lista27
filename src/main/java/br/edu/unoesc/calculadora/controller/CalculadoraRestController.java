...
public class CalculadoraRestController {
	...
	public RedirectView somarQuery(@RequestParam(value = "n1", defaultValue = "0") Double n1,
			@RequestParam(value = "n2", defaultValue = "0") Double n2, RedirectAttributes atributos) {
	...
	public Double multiplicarPath(@PathVariable String numero1, @PathVariable String numero2,
			@ModelAttribute("v1") Double v1, @ModelAttribute("v2") Double v2, Model model) {
	...
	public ModelAndView dividirQuery(@RequestParam(value = "n1", defaultValue = "0") String n1,
			@RequestParam(value = "n2", defaultValue = "0") String n2, ModelMap modeloMap) {
	...
	public String dividirPath(@PathVariable String n1, @PathVariable String n2, @ModelAttribute("valor") String valor,
			Model modelo) {
	...
	public ModelAndView calcularMediaQuery(@RequestParam(value = "n1", defaultValue = "0") String n1,
			@RequestParam(value = "n2", defaultValue = "0") String n2, HttpServletRequest requisicao) {
	...
	public Double calcularMediaPath(@PathVariable String numero1, @PathVariable String numero2,
	...
	public  RedirectView calcularPotenciaQuery(@RequestParam(value = "base", defaultValue = "0") String base,
			@RequestParam(value = "expoente", defaultValue = "0") String expoente, ModelMap model) {
		model.addAttribute("v1", base);
		model.addAttribute("v2", expoente);

		return new RedirectView("/calcular-potencia-path/"+base+"/"+expoente);
	}
